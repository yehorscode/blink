...
class WeatherPlugin:
    ...
    async def render(self) -> Image.Image:
        ...
        draw.text((20, 20), "This is a weather extension!", fill=(0, 0, 0), font=ImageFont.truetype(sans_font, 10))
        draw.text((10, 60), "Humidity: 30%", fill=(0, 0, 0), font=ImageFont.truetype(sans_font, 5))
